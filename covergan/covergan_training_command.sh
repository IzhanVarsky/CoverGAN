...
python3 ./covergan_train.py --train_dir ./dataset_full_covers --emotions ./emotions.json --epochs 50000 --display_steps 100
#python3 ./colorer_train.py --train_dir ./dataset_full_covers --emotions ./emotions.json --epochs 50000 --display_steps 100